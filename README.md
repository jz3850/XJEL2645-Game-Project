...
2.	When you enter the main menu. There are three items: Play, Game tutorial and difficulty selection. You can select game tutorial to read the game rules, and you can select the difficulty to change the difficulty degree.
3.	While playing, you can pause the game at any time by pressing the Nucleo blue button, and there are three items on the pause menu: Continue, Restart and Back to the main menu.
...
The first feature is the hit feedback and scoring system. Since this is a game project, to improve the playability is the primary principle. Being able to get feedback from the game is what keeps the players feeling interested and attracted. The functions which include hit feedback (Perfect, Good and Miss), the combo count, the aggregate score and the level classification (S, A, B and C) are all trying to give the players a goal to achieve to make them more engaged and enjoy it. Since I used to be a music game player, I have paid attention to the feedback that the game gives players.
The second feature is that this project focuses on the user experience and the robustness of the game. Except for the gameplay part, this game is well packaged with many player-friendly functions:
1.	There are three menus: the main menu, the difficulty selection menu and the pause menu. 
2.	There are 6 functions besides gameplaying: Game tutorial, Difficulty selection, Pause, Continue, Restart and Back to the main menu.
Improving the user experience is also an important part of engineering design, and the experience of the calculator menu project last semester has helped me a lot in this process.
...
Overall, the project was successfully completed, and this is a challenging but interesting project experience for me.
